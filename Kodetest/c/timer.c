...
void TIM1_BRK_TIM15_IRQHandler(void){
    ...
    if (tid.joystickdebouncer >= 65000){
        tid.joystickdebouncer = 0;
    }
...
void setTimer(uint8_t difficulty, uint8_t levelspeed){
    ...
    TIM15->ARR = 0x00009C3F/(1+2*difficulty+levelspeed); // Set reload value to 3999 - VED GODT MAN IKKE MÅ SKRIVE 0.25 og 0.5
    TIM15->PSC = 0x000F; // Set prescale value to 15
