...
void drawHighscoreWindow(struct game_state_t* gs) {
    ...
    printf("Highscores");
    underline(0);
    gotoxy(MENUX1+INCRX+4,MENUY1+2);
    ...
    gotoxy(MENUX1+INCRX+6,MENUY1+2);
    ...
    gotoxy(MENUX1+INCRX+8,MENUY1+2);
    ...
    gotoxy(MENUX1+INCRX+10,MENUY1+2);
    ...
    gotoxy(MENUX1+INCRX+12,MENUY1+2);
